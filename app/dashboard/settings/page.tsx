            ...
            <div className="px-8 pt-20 pb-8">
              ...
              <div className="sticky top-[100px] z-40">
                <Tabs defaultValue={activeTab} onValueChange={setActiveTab}>
                  ...
                  {/* Tab Contents */}
                  <TabsContent value="my-details"><TabDetails /></TabsContent>
                  <TabsContent value="password"><TabPassword /></TabsContent>
                  <TabsContent value="notifications"><TabNotifications /></TabsContent>
                  <TabsContent value="system"><TabSystem /></TabsContent>
                </Tabs>
              </div>
            </div>
          </div>
