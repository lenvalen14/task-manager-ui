    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled
      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-x-16">
          <a href="#hero" className="nav-link">Trang chủ</a>
          <a href="#feature" className="nav-link">Tính năng</a>
          <a href="#feedback" className="nav-link">Phản hồi</a>
        </nav>

        {/* Nút Đăng nhập / Dashboard */}
